      ...
      <div className="bg-white w-full flex flex-col">
        ...
        <div className="mt-[25px] h-10 bg-[#f7f7f7] text-black flex justify-center">
          <div className="flex flex-row justify-between items-center font-proxima font-thin text-black">
            <Link className={n != 1 ? "px-2.5" : "text-[#ee7f34] px-2.5"} href="/clicktopray"> Click to Pray </Link>
            <Link className={n != 2 ? "px-2.5" : "text-[#ee7f34] px-2.5"} href="/horario"> Horário </Link>
            <Link className={n != 3 ? "px-2.5" : "text-[#ee7f34] px-2.5"} href="/musicas"> Músicas </Link>
            <Link className={n != 4 ? "px-2.5" : "text-[#ee7f34] px-2.5"} href="/grupos"> Grupos de Serviço </Link>
          </div>
        </div>
      </div>
    );
