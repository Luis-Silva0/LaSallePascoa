...
const Nav = () => {
    return (
      <div className="bg-white w-full h-[135px] flex flex-col">
        <div className="w-full flex flex-row justify-between">
          ...
          <div className="w-1/3 flex justify-center items-center pt-3 font-proxima font-extralight">
            <Link className="w-[90px] h-[30px] md:w-[142px] md:h-[40px] bg-[#015450] flex font-xs justify-center content-center" href="https://docs.google.com/forms/d/e/1FAIpQLSetJ2tPRpLhiWGG-bjHxysMctuPs5tEzyugp5NoepFxY64nig/viewform?usp=sf_link" > Inscrições </Link>
          </div>
        </div>
