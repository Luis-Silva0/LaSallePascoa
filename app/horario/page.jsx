...
export default function Horario() {
    ...
    const date = new Date();
    const countdown = 16 - date.getUTCDate();
    const dias = (countdown == 1) ? "dia" : "dias";
    const faltas = (countdown == 1) ? "Falta" : "Faltam";
    const day = date.getUTCDay();
    const [dia,setDia] = useState("");
    const quinta = (dia == "Quinta-feira") ? {backgroundColor: 'white',borderColor:"#3a90bc", color: "#3a90bc" } : {backgroundColor: "#3a90bc",borderColor:"#3a90bc"}
    const sexta = (dia == "Sexta-Feira") ? {backgroundColor: 'white',borderColor:"#3a90bc",color: "#3a90bc" } : {backgroundColor: "#3a90bc",borderColor:"#3a90bc"}
    const sabado = (dia == "Sábado") ? {backgroundColor: 'white',borderColor:"#3a90bc",color: "#3a90bc" } : {backgroundColor: "#3a90bc",borderColor:"#3a90bc"}
