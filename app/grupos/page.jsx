    ...
    return (countdown > 0) ? (
        ...
        <div className="bg-white w-full flex items-center justify-center">
            <div className="flex w-[75%] md:w-[65%] 2xl:w-[60%] mt-4 flex flex-col gap-5">
                <h1 style={{color: "#3a90bc"}} className={` font-work-sans text-[38px]`}> Grupos de Serviço </h1>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {grupos.map((group,index) => (
                        <div style={{backgroundColor: "#3a90bc"}} className={`flex flex-col aspect-square 2xl:py-5 pt-3 2xl:px-5 px-4 gap-3 md:gap-1 2xl:gap-3`}>
